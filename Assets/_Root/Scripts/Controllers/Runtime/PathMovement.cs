...
namespace _Root.Scripts.Controllers.Runtime
{
	...
	/// </summary>
	[AddComponentMenu("Tools/Movement/PathMovement")]
	public class PathMovement : MonoBehaviour 
	{
		...
		public virtual void MoveAlongThePath()
		{
			switch (AccelerationType)
			{
				...
				case PossibleAccelerationType.AnimationCurve:
					...
					float remappedDistance = 1 - MathU.Remap (_distanceToNextPoint, 0f, distanceBetweenPoints, 0f, 1f);
		...
		{	
			...
			for (int i=0;i<PathElements.Count;i++)
			{
				...
				DebugExt.DrawGizmoPoint(PointPosition(i),0.2f,Color.green);
			...
			{
				DebugExt.DrawGizmoPoint(PointPosition(_currentPoint.Current), 0.2f, Color.blue);
				DebugExt.DrawGizmoPoint(PointPosition(_previousPoint),0.2f,Color.red);
			}
			#endif
		}
